export const datosModulos = {
    WhatsApp: {
        ...
        color: "#4b983d",
        fondo: "#dce8d4",
        mensajeVoz: "Estás en el módulo de WhatsApp. Escoge un nivel para practicar paso a paso.",
        niveles: [
            {
                id: "enviar-mensaje",
    ...
    YouTube: {
        ...
        color: "#d9372f",
        fondo: "#f7dddd",
        mensajeVoz: "Estás en el módulo de YouTube. Escoge un nivel para aprender a usar videos.",
        niveles: [
            {
                id: "buscar-video",
                titulo: "Buscar video",
    ...
    Contactos: {
        ...
        color: "#7b4b24",
        fondo: "#eadfce",
        mensajeVoz: "Estás en el módulo de Contactos. Escoge un nivel para practicar llamadas y contactos.",
        niveles: [
            {
                id: "guardar-contacto",
